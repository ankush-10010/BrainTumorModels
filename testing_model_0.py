...
test_loader=DataLoader(dataset=test_dataset,
                       batch_size=BATCH_SIZE,
                       shuffle=True)
checkpoint=torch.load(r"C:\CODE\Python\BrainTumorModels\trained_models_data\model_0_checkpoint.pth")
from model_0 import BrainTumorModelV0
X_train_0,label_0=train_dataset[0]
print(X_train_0.shape)
print(len(train_dataset.classes))

model_0=BrainTumorModelV0(input_shapes=3*72*72,hidden_units=16,output_shapes=len(train_dataset.classes))
...
torch.save({
    ...
    "loss":loss.item(),
}, r"C:\CODE\Python\BrainTumorModels\trained_models_data\model_0_checkpoint.pth")
